...
interface IntroHeadlineProps {
    education_bool: boolean;
    Education: string;
}

const Education: React.FC<IntroHeadlineProps> = ({ education_bool, Education }) => {
    const handleEdit = () => {
        ...
        <View style={styles.container}>
            <View style={styles.titleContainer}>
                ...
                <TouchableOpacity style={styles.linkedit} onPress={handleEdit}>
                    ...
                    <Text style={styles.edit}>Add Education</Text>
                </TouchableOpacity>
            </View>
            <View style={styles.innerContainer}>
                {education_bool ? (
                    ...
                    <View style={styles.innerInfo}>
                        <Text style={styles.NoIntrotext}>No Education added</Text>
                    </View>
                )}
            </View>
        </View>
