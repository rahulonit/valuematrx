...
import { View, ImageBackground, Text, StyleSheet, Animated, TouchableOpacity, ScrollView, Image } from 'react-native';
    ...
    return (
        <ScrollView contentContainerStyle={styles.mainContainer}>
            ...
            <View style={styles.contentContainer}>
                ...
                <Button title="Sign in" size='large' onPress={redirectSignIn} color={colors.greenGreenColor} />
                <View >
